...
import corporateImg from "../../../assets/brand1.png";
import brandingImg from "../../../assets/brand2.png";
import largeFormatImg from "../../../assets/brand3.png";
...
const services: Service[] = [
  {
    ...
    desc: "Creating unique visual symbols that represent your core values.",
    icon: <FaPalette />,
    image: corporateImg,
  },
  {
    title: "Brand Identity Systems",
    desc: "Comprehensive systems tailored to your client's values and objectives.",
    icon: <RiCupFill />,
    image: brandingImg,
  },
  {
    title: "Visual Guidelines",
    desc: "Establishing rules to maintain consistency across all media.",
    icon: <FaPen />,
