...
import corporateImg from "../../../assets/corprate2.png";
import brandingImg from "../../../assets/corprate3.png";
import largeFormatImg from "../../../assets/corprate4.png";
...
const services: Service[] = [
  {
    title: "Letterheads",
    desc: "Official letterheads printed on premium paper stock.",
    icon: paper,
    image: corporateImg,
  },
  {
    title: "Complimentary Cards",
    desc: "High-quality cards produced with clean finishing to reflect professionalism.",
    icon: canvas,
    image: brandingImg,
  },
  {
    title: "Job Printing",
    desc: "Forms, manuals, and other job-related print requirements executed with accuracy for internal and external use.",
    icon: book,
